...
(2, 'user', '$2y$10$TpipIS3PDfeHTJWggvnFO.eT/dVBMyVKI5OcYV1avGMnt8wTqOt5O', 'user@email.com', 'Administrator', '08123456789', 'admin', '2021-02-08 14:12:03', 'user_no_image.jpg', '2019-12-10 15:46:40', 1);
...
--
ALTER TABLE `data_transaksi_monthly`
  MODIFY `id_transaksi_monthly` int(11) NOT NULL AUTO_INCREMENT;
