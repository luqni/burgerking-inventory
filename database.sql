...
--
-- Host: localhost
-- Generation Time: Feb 14, 2021 at 08:40 PM
...
(1, 1, 'Tes', 2, '2', '2021-02-15'),
(2, 1, 'item tree', 2, 'admin', '2021-02-14'),
(3, 1, 'item two', 2, 'user', '2021-02-14');
...
(2, 'user', '$2y$10$TpipIS3PDfeHTJWggvnFO.eT/dVBMyVKI5OcYV1avGMnt8wTqOt5O', 'user@email.com', 'Administrator', '08123456789', 'admin', '2021-02-14 18:10:48', 'user_no_image.jpg', '2019-12-10 15:46:40', 1),
(3, 'manager', '$2y$10$TpipIS3PDfeHTJWggvnFO.eT/dVBMyVKI5OcYV1avGMnt8wTqOt5O', 'user@email.com', 'Administrator', '08123456789', 'admin', '2021-02-14 16:34:16', 'user_no_image.jpg', '2019-12-10 15:46:40', 1);
...
(1, 'Product 1', 12, 'Keterangan', '2021-02-15'),
(2, 'Product 2', 2, 'ket ket', '2021-02-14');
