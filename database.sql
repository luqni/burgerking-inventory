...
--
-- Host: localhost
-- Generation Time: Feb 10, 2021 at 12:12 PM
...
(1, 1, 2, 100, '2021-01-30'),
(2, 2, 4, 200, '2021-02-07'),
(14, 1, 1, 50, '2021-02-08'),
(15, 3, 2, 200, '2021-02-08');
...
(1, 1, 1, 50, '2021-02-08'),
(2, 2, 5, 250, '2021-02-08'),
(3, 3, 5, 500, '2021-02-08');
...
INSERT INTO `transfer` (`id`, `id_cabang`, `item_name`, `qty`, `approved`) VALUES
(1, 1, 'Item One', 1, 'Admin');
...
(2, 'user', '$2y$10$TpipIS3PDfeHTJWggvnFO.eT/dVBMyVKI5OcYV1avGMnt8wTqOt5O', 'user@email.com', 'Administrator', '08123456789', 'admin', '2021-02-10 10:18:14', 'user_no_image.jpg', '2019-12-10 15:46:40', 1);
...
INSERT INTO `waste` (`id`, `product`, `qty`, `keterangan`) VALUES
(1, 'Product 1', 12, 'Keterangan');
...
--
ALTER TABLE `data_transaksi_monthly`
  MODIFY `id_transaksi_monthly` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
